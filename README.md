...
```bash
node dist/extract-pure-entanglements.js --input=output/10x10-2star-entanglements.json [--output=output.json] [--minOccurrences=2]
```
...
```bash
node dist/mine-constrained-entanglements.js --input=output/10x10-2star-entanglements.json [--output=output.json] [--minOccurrences=2]
```
...
```bash
node dist/mine-triple-entanglements.js --input=output/10x10-2star-entanglements.json --solutions=output/10x10-2star-entanglements-solutions.json [--output=output.json] [--minOccurrences=2]
```
